...
def get_project_streams(plugin: "SpeckleQGISv3"):
    try:
        proj = plugin.project
...
def set_project_streams(plugin: "SpeckleQGISv3"):
    try:
        proj = plugin.project
...
def get_project_saved_layers(plugin: "SpeckleQGISv3"):
    try:
        proj = plugin.project
...
def set_project_layer_selection(plugin: "SpeckleQGISv3"):
    try:
        proj = plugin.project
