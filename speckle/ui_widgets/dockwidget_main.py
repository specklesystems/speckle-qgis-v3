...
from specklepy_qt_ui.qt_ui.dockwidget_main import (
    SpeckleQGISv3Dialog as SpeckleQGISv3Dialog_UI,
)
...
class SpeckleQGISv3Dialog(SpeckleQGISv3Dialog_UI, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(SpeckleQGISv3Dialog_UI, self).__init__(parent)
